...
Названия и описания делай максимально полезными и точными 
для последующего создания промпта для генерации изображения. Если на фото есть текст описывай его на том языке на котором он изображон.
