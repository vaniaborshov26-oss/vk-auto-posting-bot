...
photo_title:
Красивое и точное название изображения.
...
Укажи фотореализм, детализацию,
естественную анатомию, реалистичную кожу,
отсутствие CGI и артефактов.
...
def build_wall_post_text(data):
    ...
    return f"""⚠️Берешь промпт — обязательно ставь лайк ❤️ на пост и оставляй любой комментарий! {title}
